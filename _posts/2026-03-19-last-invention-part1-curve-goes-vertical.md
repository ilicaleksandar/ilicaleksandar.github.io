...
header:
  overlay_image: /assets/images/last-invention-1.png
  overlay_filter: rgba(0, 0, 0, 0.5)
  caption: "The GDP curve is about to go vertical"
  teaser: /assets/images/last-invention-1.png
og_image: /assets/images/last-invention-1.png
related_posts:
...
excerpt: "Nick Bostrom's Superintelligence reveals why the next economic jump makes the industrial revolution look like a rounding error."
---
...
**Continue Reading:** [Part 2: Three Roads to the Same Destination]({% post_url 2026-03-19-last-invention-part2-three-roads %})
